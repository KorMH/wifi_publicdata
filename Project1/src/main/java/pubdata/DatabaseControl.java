...
public class DatabaseControl {
	...
	public boolean dbNumCheck() {
		// # DB 접속에 필요한 정보 입력
//		String url = "jdbc:mariadb://localhost:3306/publicdata";
		String url = "jdbc:mariadb://localhost:3306/publicdata?useUnicode=true&characterEncoding=utf8mb4";
        String dbUserId = "root";
        String dbUserPw = "zerobase";
